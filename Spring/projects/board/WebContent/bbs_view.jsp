...
<!--게시물-->
  ...
  <tr><td colspan=2 height=1 background=./images/dotline.gif></td></tr>
    ...
    <tr>  
      ...
      <td style="text-align:right;">
        <c:if test='${article.fileYN == \'Y\'}'>
          <c:forEach var="file" items="${article.files }">
            <!-- a href="filedown.jsp?file=${file.savedfile}">${file.filename }</a --><!--  -&nbsp;&nbsp;-->
            <a href="fileview.do?fid=${file.fid}">${file.filename }</a>
          </c:forEach>
        </c:if>
      </td>
    </tr>
